...
import UsersListFooter from '../../users/components/UsersListFooter';
import type { Organization } from '../../../store/organizations/duck';
import type { Member } from '../store/membersDuck';
  ...
  render() {
    ...
    return (
      <div className="page page-limited">
        ...
        <UsersList users={members} organization={organization} />
        <UsersListFooter
